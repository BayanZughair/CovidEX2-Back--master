...
from CovidApp.models import User
from CovidApp.serializers import UserSerializer
...
def exportToExcel(request):
    if request.method == 'GET':
        ...
        cols = [  '#id', 'firstName','lastName',' Date-of-Birth',
            'Address','City','zipCode','landLine',
            'cellularPhone','Covid-19 Infected', 'Diabetes',
            'Cardio Problems','Allergies','Other',]
        ...
        rows = User.objects.all().values_list(
            ...
            'city','zip_code','landline','cellular_phone','is_covid_19_infected',
            'have_diabetes','have_cardio_problems', 'have_allergies', 'have_other_medical_conditions'
        )
